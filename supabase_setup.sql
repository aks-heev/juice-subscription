...
-- 2b. Create the orders table for one-time purchases
...
SELECT * FROM (VALUES 
  ('Green Goddess', 'Spinach, kale, apple, cucumber, lemon, ginger', 149, 'detox', '🥬', 120, '500ml'),
  ('Sunrise Boost', 'Orange, carrot, turmeric, ginger, lemon', 129, 'energy', '🍊', 150, '500ml'),
  ('Berry Shield', 'Blueberry, strawberry, acai, pomegranate, honey', 179, 'immunity', '🫐', 180, '500ml'),
  ('Tropical Breeze', 'Pineapple, mango, coconut water, mint', 139, 'refresh', '🍍', 140, '500ml'),
  ('Power Punch', 'Banana, peanut butter, oats, almond milk, honey', 199, 'protein', '💪', 320, '500ml'),
  ('Citrus Cleanse', 'Grapefruit, orange, lemon, lime, mint', 119, 'detox', '🍋', 95, '500ml')
...
-- 7b. Create policies for orders (user-specific access)
